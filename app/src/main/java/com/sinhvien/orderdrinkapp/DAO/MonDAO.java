...
public class MonDAO {
    ...
    public boolean ThemMon(MonDTO monDTO) {
        ...
        contentValues.put(CreateDatabase.TBL_MON_HINHANH, monDTO.getHinhAnh()); // Now a String
    ...
    public boolean XoaMon(int mamon) {
        long ktra = database.delete(CreateDatabase.TBL_MON, CreateDatabase.TBL_MON_MAMON + " = " + mamon, null);
        return ktra != 0;
    }
    ...
    public boolean SuaMon(MonDTO monDTO, int mamon) {
        ...
        long ktra = database.update(CreateDatabase.TBL_MON, contentValues, CreateDatabase.TBL_MON_MAMON + " = " + mamon, null);
        return ktra != 0;
    }
    ...
    public List<MonDTO> LayDSMonTheoLoai(int maloai) {
        ...
        while (!cursor.isAfterLast()) {
            ...
            monDTO.setHinhAnh(cursor.getString(cursor.getColumnIndex(CreateDatabase.TBL_MON_HINHANH))); // Retrieve as String
